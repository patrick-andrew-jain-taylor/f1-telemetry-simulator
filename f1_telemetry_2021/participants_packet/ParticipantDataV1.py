...
class ParticipantDataV1(PackedLittleEndianStructure):
    """This type is used for the 22-element 'participants' array of the PacketParticipantsData_V1 type,
    defined below. """
    _fields_ = [
        ...
        ('networkId', ctypes.c_uint8),  # Network id – unique identifier for network players
